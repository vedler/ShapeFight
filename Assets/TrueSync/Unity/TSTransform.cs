    ...
    public class TSTransform : MonoBehaviour {
        ...
        **/
        public void Rotate(TSVector axis, FP angle, Space relativeTo) {
            if (relativeTo == Space.Self) {
                this.rotation *= TSQuaternion.AngleAxis(angle, axis);
            } else {
                this.rotation = TSQuaternion.AngleAxis(angle, axis) * this.rotation;
            }
        }
        ...
        **/
        public void Rotate(TSVector eulerAngles, Space relativeTo) {
            if (relativeTo == Space.Self) {
                this.rotation *= TSQuaternion.Euler(eulerAngles);
            } else {
                this.rotation = TSQuaternion.Euler(eulerAngles) * this.rotation;
            }
        }
